...
@section('breadcrumb', 'Configuración / Secciones / Nueva')
...
@section('content')
    ...
    <div class="max-w-md">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <form method="POST" action="{{ route('configuracion.secciones.store') }}"
                  x-data="{
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        @error('id_grado')
                            <p class="text-red-600 text-xs mt-1.5">{{ $message }}</p>
                        @enderror
                        <p class="text-gray-400 text-xs mt-1.5" x-show="!selectedNivel">Primero selecciona un nivel educativo.</p>
                    </div>
