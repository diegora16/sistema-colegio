...
@section('page-title', 'Editar Nivel Educativo')
@section('breadcrumb', 'Configuración / Niveles Educativos / Editar')
...
@section('content')
    ...
    <div class="max-w-md">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <form method="POST" action="{{ route('configuracion.niveles.update', $nivel) }}">
                @csrf
                @method('PUT')
                        ...
                        <select id="id_año"
                            ...
                            @foreach ($anios as $anio)
                                <option value="{{ $anio->id }}"
                                    {{ old('id_año', $nivel->id_año) == $anio->id ? 'selected' : '' }}>
                                    {{ $anio->nombre }}
